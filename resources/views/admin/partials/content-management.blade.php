<li class="nav-item
  ...
  <div class="collapse
    ...
    <ul class="nav nav-collapse">
      ...
      @canany(['settings-services','category-services','services'])
      {{-- Service Management --}}
      <li class="
      ...
      @canany(['category-blog','blogs','archives'])
      {{-- Blogs Management --}}
      <li class="
      ...
      @canany(['settings-gallery','categories-gallery','galleries'])
      {{-- Gallery Management --}}
      <li class="
      ...
      @canany(['settings-faq','categories-faq','faqs'])
      {{-- FAQ Management --}}
      <li class="
      ...
      @canany(['categories-career','post-job','job-management'])
      {{-- Career Page --}}
      <li class="
